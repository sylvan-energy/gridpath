...
(data_toolkit.geographic_scope) and characteristic filters
(data_toolkit.project.fleet.fleet_filters) have already selected, combining a
...
from data_toolkit.geographic_scope import get_load_zone_str
from data_toolkit.project.fleet.ba_assignment import GENERATORS_TABLE_COLUMNS
