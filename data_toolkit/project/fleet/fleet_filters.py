...
to where they are (data_toolkit.geographic_scope) or how they are grouped
into projects (data_toolkit.project.fleet.aggregation). The
...
from data_toolkit.geographic_scope import get_footprint_scope_sql
from data_toolkit.project.fleet.ba_assignment import get_generators_table_str
...
def get_fleet_relation_sql(
    ...
    from data_toolkit.project.fleet.aggregation) on top of this relation and
