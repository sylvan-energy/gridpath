...
characteristics (see data_toolkit.project.fleet.fleet_filters) or at how units
are aggregated into projects (see data_toolkit.project.fleet.aggregation). The
project, system, and transmission steps all consume this module, which is
why it lives at the data_toolkit level.
"""
