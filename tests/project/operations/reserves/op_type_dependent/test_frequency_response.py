...
class TestFrequencyResponseByOpType(unittest.TestCase):
    """ """
    ...
    def test_data_loaded_correctly(self):
        ...
        actual_rr_limit = OrderedDict(
            sorted(
                {
                    prj: instance.frequency_response_ramp_rate_limit[prj]
                    for prj in instance.FREQUENCY_RESPONSE_PROJECTS
                }.items()
            )
        )
