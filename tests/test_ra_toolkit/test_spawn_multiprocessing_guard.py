...
def _run_pool_fn_in_worker(queue):
    ...
    with (
        patch(
            "ra_toolkit.project.stochastic.monte_carlo_gen_common"
            ".connect_to_database",
            return_value=mock_conn,
        ),
        patch(
            "ra_toolkit.project.stochastic.monte_carlo_gen_common" ".pd.read_sql",
            return_value=dummy_units,
        ),
        patch(
            "ra_toolkit.project.stochastic.monte_carlo_gen_common" ".get_context",
