...
STEP_PROFILES = {
    "eia860_to_project_portfolio_input_csvs": (
        "data_toolkit.project.portfolios",
        DEFAULT_PROFILE,
    ),
    "eia860_to_project_load_zone_input_csvs": (
        "data_toolkit.project.load_zones",
        DEFAULT_PROFILE,
    ),
    "eia860_to_project_availability_input_csvs": (
        "data_toolkit.project.availability",
        DEFAULT_PROFILE,
    ),
    "eia860_to_project_specified_capacity_input_csvs": (
        "data_toolkit.project.capacity_specified",
        DEFAULT_PROFILE,
    ),
    ...
    "eia860_to_project_fixed_cost_input_csvs": (
        "data_toolkit.project.fixed_cost",
        DEFAULT_PROFILE,
    ),
    "eia860_to_project_opchar_input_csvs": (
        "data_toolkit.project.opchar",
        DEFAULT_PROFILE,
    ),
    "fleet_audit": ("data_toolkit.project.fleet", DEFAULT_PROFILE),
    "eia860_to_project_fuel_input_csvs": (
        "data_toolkit.project.opchar.fuels",
        ZONE_AGNOSTIC_PROFILE,
    ),
    "eia860_to_project_heat_rate_input_csvs": (
        "data_toolkit.project.opchar.heat_rates",
        ZONE_AGNOSTIC_PROFILE,
    ),
    "manual_adjustments": ("data_toolkit.project", POST_PROCESSING_PROFILE),
}
