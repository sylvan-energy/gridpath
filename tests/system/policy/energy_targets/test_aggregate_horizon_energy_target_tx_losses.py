...
class TestAggregateHorizonEnergyTargetTxLosses(unittest.TestCase):
    """ """
    ...
    def test_no_transmission_energy_target_inputs(self):
        ...
        should still build and the transmission contribution to the energy
        target constraint should be an empty sum.
        :return:
        """
