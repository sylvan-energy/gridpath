...
LOCAL_CAPACITY_ZONE_PRD_DF = "local_capacity_zone_period_df"
...
def import_results_into_database(
    ...
    import_csv(
        ...
        which_results="system_local_capacity",
    )
