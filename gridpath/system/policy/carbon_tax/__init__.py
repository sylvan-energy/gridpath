...
CARBON_TAX_ZONE_PRD_DF = "carbon_tax_zone_period_df"
...
def import_results_into_database(
    ...
    import_csv(
        ...
        which_results="system_carbon_tax",
    )
