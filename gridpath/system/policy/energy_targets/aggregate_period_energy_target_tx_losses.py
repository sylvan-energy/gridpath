...
and count them against the zone's period energy target.
"""
...
def add_model_components(
    ...
    def total_tx_losses_rule(mod, z, p):
        """
    ...
    m.Total_Period_Energy_Target_Tx_Losses_MWh = Expression(
...
def record_dynamic_components(dynamic_components):
    ...
    Count transmission losses against the period energy target constraint.
    """

    getattr(
        dynamic_components, period_energy_target_balance_contribution_components
    ).append("Total_Period_Energy_Target_Tx_Losses_MWh")
