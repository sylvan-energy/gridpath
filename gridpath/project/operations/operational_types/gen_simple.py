    ...
    **Enforced Over**: GEN_SIMPLE_OPR_TMPS
    ...
    if check_if_boundary_type_and_first_timepoint(
        ...
        if check_if_boundary_type_and_first_timepoint(
            ...
            prev_tmp_power = mod.GenSimple_Provide_Power_MW[g, prev]
            prev_tmp_downwards_reserves = mod.GenSimple_Downwards_Reserves_MW[g, prev]
    ...
    **Enforced Over**: GEN_SIMPLE_OPR_TMPS
    ...
    if check_if_boundary_type_and_first_timepoint(
        ...
        if check_if_boundary_type_and_first_timepoint(
            ...
            prev_tmp_hrs_in_tmp = mod.hrs_in_tmp[prev]
            prev_tmp_power = mod.GenSimple_Provide_Power_MW[g, prev]
            prev_tmp_upwards_reserves = mod.GenSimple_Upwards_Reserves_MW[g, prev]
        # If ramp rate limits, adjusted for timepoint duration, allow you to
